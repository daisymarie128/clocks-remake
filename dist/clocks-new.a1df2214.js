...
var Clock = function () {
  ...
  // constructor() { }
  function Clock(size, index, firstHandRotation, secondHandRotation) {
...
console.log('---- size??', clockGrid);
for (var i = 0; i < clockGrid.rows; i++) {
  for (var x = 0; x < clockGrid.columns; x++) {
...
//# sourceMappingURL=/clocks-new.a1df2214.map